 ...
 **Правило прямого ответа:**
 ...
 - **Docker** (Python) — среда выполнения.
 - **Файловая система** — код, промпты, Конституция.
 - **Локальное хранилище** (`/app/data`) — логи, память, рабочие файлы.
 ...
 **Чтение:** `repo_read`, `repo_list`, `drive_read` (теперь data), `drive_list`, `codebase_digest`
